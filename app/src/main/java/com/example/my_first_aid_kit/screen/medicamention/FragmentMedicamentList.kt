...
class FragmentMedicamentList : Fragment() {

    companion object {
        fun newInstance() = FragmentMedicamentList()
    }
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_medicamention_list, container, false)
    }
}